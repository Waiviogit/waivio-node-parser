...
const Create = async ( { children, author, additionsForMetadata = {}, onlyData, parent_permlink, additionsForPost = {}, active_votes = [], app, root_author, permlink } = {} ) => { // additionsForMetadata(Post) must be an Object
    const json_metadata = {
