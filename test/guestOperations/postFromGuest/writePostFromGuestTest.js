const { expect, sinon, faker, postWithObjectParser, Post, postsUtil, commentRefGetter } = require( '../../testHelper' );
...
describe( 'On postWithObjectParser', async () => {
    ...
    describe( 'when post was written from guest user', async () => {
        let mockPost, mockMetadata, mockOp, guestAuthor, proxyBotAuthor, mockWobj;
        beforeEach( async () => {
            ...
            mockPost = await PostFactory.Create( {
                onlyData: true, author: proxyBotAuthor.name,
