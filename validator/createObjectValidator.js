...
const validateFields = (data) => {
    const requiredFieldsCreateObject = 'author_permlink,author,creator,object_type,default_name'.split(',');
...
const validatePostLinks = async (data, operation) => {
    ...
    if (!result || !result.type || result.type !== 'wobj_type' || result.name !== data.object_type) {
