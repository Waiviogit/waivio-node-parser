...
const { reservationStatuses, campaignsStatuses, types } = require('constants/campaigns');
...
const userSchema = new mongoose.Schema({
  ...
  status: {
    type: String, enum: Object.values(reservationStatuses), required: true, default: 'assigned',
  },
...
const campaignV2Schema = new mongoose.Schema({
  ...
  status: { type: String, enum: Object.values(campaignsStatuses), default: 'pending' },
